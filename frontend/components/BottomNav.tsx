...
import { Search, Briefcase, MessageSquare, User, ShieldCheck, Heart, Clapperboard } from "lucide-react";
...
const TABS: Tab[] = [
  ...
  { href: "/publicaciones", label: "Publicaciones", icon: Clapperboard, match: (p) => p.startsWith("/publicaciones") },
