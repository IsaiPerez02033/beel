    ...
    <div className="flex justify-center gap-2 mb-6">
      {tabs.map((t) => (
        <Link
          ...
          href={t.href}
          className={cn(
            "btn flex items-center gap-2 px-5 py-2.5 rounded-full text-body-sm font-medium transition-all duration-300 border hover:scale-[1.02] active:scale-95",
            active === t.key
              ? "bg-[var(--color-primary)] text-white border-[var(--color-primary)] shadow-sm hover:text-white"
